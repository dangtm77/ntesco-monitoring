...
class _BodyPageState extends State<Body> {
  ...
  Widget _item(SystemReportModel item) {
    ...
    //                 Navigator.pushNamed(
    //                     context, MaintenanceUpdateScreen.routeName,
    //                     arguments: {'id': item.id, 'tabIndex': 0});
    //               },
    //             ),
    //             ListTile(
    //               title: Row(
    ...
    //             TextSpan(
    //                 text: "${item.id}", style: TextStyle(color: kTextColor)),
    ...
    //             WidgetSpan(child: SizedBox(width: 2.0)),
    //             TextSpan(
    //                 text: "${item.typeInfo?.text ?? "Chưa xác định"}",
    ...
    //             WidgetSpan(child: SizedBox(width: 2.0)),
    //             TextSpan(
    //                 text: "${item.statusInfo.text ?? "Chưa xác định"}",
    //                 style: TextStyle(color: kTextColor)),
    //           ],
    //         ),
    //       ),
    ...
    //             WidgetSpan(child: SizedBox(width: 2.0)),
    //             TextSpan(
    //                 text: "${StringHelper.toShortName(item.staffInfo.hoTen)}",
    //                 style: TextStyle(color: kTextColor)),
    //             WidgetSpan(child: SizedBox(width: 15.0)),
    //             WidgetSpan(
    ...
    //             TextSpan(
    //                 text:
    //                     "${DateFormat("hh:mm dd/MM/yy").format(item.dateCreate!)}",
    //                 style: TextStyle(color: kTextColor)),
    //           ],
    //         ),
    //       ),
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          onTap: () {
                            Navigator.pop(context);
                            // ModelBottom.showCupertinoModalBottomSheet(
                            //   context: context,
                            //   builder: (context) =>
                            //       MaintenanceCreateScreen(systemModel: element),
                            //   isDismissible: false,
                            //   enableDrag: false,
                            // ).then((value) {
                            //   setState(() {
                            //     pageIndex = pageIndex + 1;
                            //     _isLoading = false;
                            //     _listOfSystemReports =
                            //         _getlistOfSystemReports();
                            //   });
                            // });
