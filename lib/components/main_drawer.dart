              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text("language_display".tr(), style: TextStyle(color: kPrimaryColor, fontWeight: FontWeight.w600)),
                      ChangeLanguage()
                    ],
                  ),
                ),
                Container(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        CircleAvatar(radius: 50.0, backgroundImage: NetworkImage(userCurrent!.avartar.toString())),
                        SizedBox(height: 5.0),
                        Text(
